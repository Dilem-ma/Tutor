...
<div ng-controller="TeachersearchCtrl">
    ...
    <div class="content" ng-hide="(gender==undefined || gender == '') && (tech==undefined || tech == '') &&(education==undefined || education == '') &&(area==undefined || area == '')">
    ...
    <div class="content" ng-show="(gender==undefined || gender == '') && (tech==undefined || tech == '') &&(education==undefined || education == '') &&(area==undefined || area == '')" style="top:14%;">
    <div class="need"  ng-repeat="x in orders">
            <div class="portrait"><a><img src="{{x.url}}"></a></div>
            <div class="need-content">
                <h1><a>{{x.name}}</a></h1>
                <div class="label"><span>{{x.star}}星</span><span>{{x.area}}</span><span ng-if="x.gender == 'male'">男性</span><span ng-if="x.gender == 'female'">女性</span><span>擅长科目：{{x.major}}</span></div>
                <div class="label"><span>个人描述：{{x.describe}}</span></div>
            </div>
        </div>
    </div>
    <div id="NotMoveDIV">

    ...
    <div class="content">
        <form action="">
            <div class="message">
                ...
                <input id="pwd" type="password" placeholder="请设置新的密码" pattern="[0-9A-Za-z]{6,25}" required/>
                <input id="pwd2" type="text" placeholder="请设置新的密码" pattern="[0-9A-Za-z]{6,25}" style="display: none" required/>
                <div class="icons">
            ...
            <button class="submit" type="submit">确认并登录</button>
        </form>
    </div>
</div>